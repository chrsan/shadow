...
func f381(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 float32, l6 int32) {
	var l7 int32
	_ = l7
	var l8 int32
	_ = l8
...
lbl2:
	...
	s5f32 = l5
	s6i32 = l6
	s0i32 = f1393(ctx, s0i32, s1i32, s2i32, s3i32, s4i32, s5f32, s6i32)
	l1 = s0i32
	...
	f592(ctx, s0i32, s1i32, s2i32, s3i32, s4i32, s5i32)
lbl4:
	s0i32 = l1
	s1i32 = 27304
	*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+0)])) = uint32(s1i32)
