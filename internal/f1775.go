...
func f1775(ctx *Context, l0 int32, l1 int32, l2 int32) int32 {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
	...
	*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+0)])) = uint32(s1i32)
	...
	s2i32 = s2i32 + s3i32
	s3i32 = 4096
	s0i32 = f369(ctx, s0i32, s1i32, s2i32, s3i32)
	s0i32 = l0
	s1i32 = 0
	...
	*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+0)])) = uint32(s1i32)
	s0i32 = l0
	s1i64 = 0
	*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+4392)])) = uint64(s1i64)
	s0i32 = l0
	s1i32 = l5
