...
func f797(ctx *Context, l0 int32, l1 int32, l2 float32, l3 float32, l4 float32, l5 float32) {
	var s0i32 int32
	_ = s0i32
	var s1i32 int32
	_ = s1i32
	...
	s4f32 = s4f32 * s5f32
	s5i32 = l0
	s5f32 = *(*float32)(unsafe.Pointer(&ctx.Mem[int(s5i32+36)]))
	s4f32 = s4f32 + s5f32
	s3f32 = s3f32 + s4f32
	s2f32 = s2f32 + s3f32
	s3i32 = l0
	...
	s5f32 = s5f32 * s6f32
	s6i32 = l0
	s6f32 = *(*float32)(unsafe.Pointer(&ctx.Mem[int(s6i32+40)]))
	s5f32 = s5f32 + s6f32
	s4f32 = s4f32 + s5f32
	s3f32 = s3f32 + s4f32
	s4i32 = l0
	...
	s6f32 = s6f32 * s7f32
	s7i32 = l0
	s7f32 = *(*float32)(unsafe.Pointer(&ctx.Mem[int(s7i32+44)]))
	s6f32 = s6f32 + s7f32
	s5f32 = s5f32 + s6f32
	s4f32 = s4f32 + s5f32
	s5f32 = l5
