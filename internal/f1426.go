...
func f1426(ctx *Context, l0 int32, l1 float64, l2 int32) int32 {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
	...
	*(*float64)(unsafe.Pointer(&ctx.Mem[int(s0i32+64)])) = s1f64
	...
	s3f64 = l6
	s4i32 = l2
	s0i32 = f570(ctx, s0f64, s1f64, s2f64, s3f64, s4i32)
	l4 = s0i32
	s1i32 = 1
	if s0i32 < s1i32 {
		s0i32 = 1
...
lbl1:
	...
	if s0i32 != 0 {
		...
		s2i32 = l0
		s3i32 = l3
		s2i32 = f567(ctx, s2i32, s3i32)
		s3f64 = l1
		s4i32 = 0
		s5i32 = l2
		s0i32 = f569(ctx, s0i32, s1i32, s2i32, s3f64, s4i32, s5i32)
		l4 = s0i32
		goto lbl0
	}
	s0i32 = l5
