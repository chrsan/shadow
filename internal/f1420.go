...
func f1420(ctx *Context, l0 float64, l1 float64, l2 float64, l3 float64, l4 int32) int32 {
	var l5 int32
	_ = l5
	var l6 int32
	_ = l6
	...
	s2f64 = l3
	s3i32 = l4
	s0i32 = f383(ctx, s0f64, s1f64, s2f64, s3i32)
	l6 = s0i32
	goto lbl0
lbl1:
	s0f64 = l3
...
lbl5:
	...
	if s0i32 != 0 {
		...
		*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+8)])) = uint64(s1i64)
		...
		s2f64 = f1359(ctx, s2f64)
		l1 = s2f64
		s3f64 = 3
		s2f64 = s2f64 / s3f64
		s2f64 = f373(ctx, s2f64)
		s1f64 = s1f64 * s2f64
		s2f64 = l0
		s1f64 = s1f64 - s2f64
		l3 = s1f64
