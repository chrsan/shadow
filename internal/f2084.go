...
func f2084(ctx *Context, l0 int32, l1 int32) {
	var l2 int32
	_ = l2
	var l3 int32
	_ = l3
...
lbl12:
	...
	s4i32 = 104
	s3i32 = s3i32 + s4i32
	s0i32 = f694(ctx, s0f32, s1f32, s2f32, s3i32)
	l1 = s0i32
	s1i32 = l2
	...
	s4i32 = s4i32 + s5i32
	s1i32 = f694(ctx, s1f32, s2f32, s3f32, s4i32)
	s0i32 = s0i32 + s1i32
	l1 = s0i32
	s1i32 = 1
	if s0i32 >= s1i32 {
...
lbl10:
	...
	s5i32 = 112
	s4i32 = s4i32 + s5i32
	s0i32 = f692(ctx, s0f32, s1f32, s2f32, s3f32, s4i32)
	l1 = s0i32
	s1i32 = l2
	s1f32 = *(*float32)(unsafe.Pointer(&ctx.Mem[int(s1i32+20)]))
	s2i32 = l2
	...
	s5i32 = s5i32 + s6i32
	s1i32 = f692(ctx, s1f32, s2f32, s3f32, s4f32, s5i32)
	s0i32 = s0i32 + s1i32
	l1 = s0i32
	s1i32 = 1
	if s0i32 >= s1i32 {
