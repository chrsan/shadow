...
func f2009(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32) {
	var l4 int64
	_ = l4
	var l5 int64
	_ = l5
	...
	if s0i32 != 0 {
		s0i32 = l1
		s0i64 = int64(*(*uint16)(unsafe.Pointer(&ctx.Mem[int(s0i32+0)])))
		l4 = s0i64
		s0i32 = 0
		l2 = s0i32
	lbl1:
		...
		s1i64 = l4
		s2i32 = l1
		s2i64 = int64(*(*uint16)(unsafe.Pointer(&ctx.Mem[int(s2i32+8)])))
		l5 = s2i64
		s1i64 = s1i64 + s2i64
		s2i32 = l1
