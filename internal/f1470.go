...
func f1470(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	var l5 int32
	_ = l5
	var l6 int32
	_ = l6
	...
	s0i32 = l0
	s0i32 = *(*int32)(unsafe.Pointer(&ctx.Mem[int(s0i32+300)]))
	l8 = s0i32
	s0i32 = l0
	s0i32 = *(*int32)(unsafe.Pointer(&ctx.Mem[int(s0i32+296)]))
	l9 = s0i32
	s0i32 = l0
	s0i32 = f1478(ctx, s0i32)
	l7 = s0i32
lbl2:
	s0i32 = l0
	s1i32 = l6
