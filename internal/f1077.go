...
func f1077(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32) {
	var l4 int32
	_ = l4
	var l5 int32
	_ = l5
		...
		*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+48)])) = uint32(s1i32)
		...
		if s0i32 != 0 {
			...
			*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+8)])) = uint64(s1i64)
			...
			s2i32 = l8
			s3i32 = l1
			s1i32 = f423(ctx, s1i32, s2i32, s3i32)
		...
		if s0i32 != 0 {
			...
			s4i32 = *(*int32)(unsafe.Pointer(&ctx.Mem[int(s4i32+20)]))
			s5i32 = l2
			f1714(ctx, s0i32, s1i32, s2i32, s3i32, s4i32, s5i32)
			s0i32 = l5
			s1i32 = 80
			s0i32 = s0i32 + s1i32
			s1i32 = l5
