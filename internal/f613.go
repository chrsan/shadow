...
func f613(ctx *Context, l0 int32, l1 int32, l2 int32) {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
	...
	*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+32)])) = uint64(s1i64)
	...
	s4i32 = 32
	s3i32 = s3i32 + s4i32
	f1063(ctx, s0i32, s1i32, s2i32, s3i32)
	s0i32 = 0
	l6 = s0i32
	s0i32 = l3
	s0i32 = *(*int32)(unsafe.Pointer(&ctx.Mem[int(s0i32+8)]))
...
lbl3:
	...
	*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+36)])) = uint32(s1i32)
	...
	s3i32 = s3i32 + s4i32
	s4i32 = l8
	s0i32 = f1695(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
	if s0i32 == 0 {
		s0i32 = 1
	} else {
		s0i32 = 0
	...
	*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+4)])) = uint32(s1i32)
	...
	if s0i32 != 0 {
		...
		*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+32)])) = uint32(s1i32)
		...
		s5i32 = 32
		s4i32 = s4i32 + s5i32
		f1666(ctx, s0i32, s1i32, s2i32, s3i32, s4i32)
		s0i32 = l0
		s0i32 = *(*int32)(unsafe.Pointer(&ctx.Mem[int(s0i32+36)]))
		l4 = s0i32
	}
