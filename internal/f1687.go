...
func f1687(ctx *Context, l0 int32, l1 int32, l2 int32) {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
...
lbl0:
	...
	if s0i32 != 0 {
		...
		f1686(ctx, s0i32, s1i32, s2i32, s3i32)
		s0i32 = l1
	...
	lbl5:
		...
		s7i32 = l12
		s0i32 = f1701(ctx, s0i32, s1i32, s2f32, s3f32, s4i32, s5i32, s6f32, s7i32)
		l5 = s0i32
		s1i32 = 108
		s0i32 = s0i32 + s1i32
		l9 = s0i32
	...
	lbl8:
		...
		lbl12:
			...
			s2i32 = l11
			s3i32 = l14
			f1688(ctx, s0i32, s1i32, s2i32, s3i32)
			s0i32 = 4
			l4 = s0i32
			goto lbl8
		lbl11:
