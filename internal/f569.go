...
func f569(ctx *Context, l0 int32, l1 int32, l2 int32, l3 float64, l4 int32, l5 int32) int32 {
	var l6 int32
	_ = l6
	var l7 int32
	_ = l7
	...
	s4i32 = s4i32 + s5i32
	s1i32 = f566(ctx, s1f64, s2f64, s3f64, s4i32)
	s2i32 = l2
	s1i32 = s1i32 + s2i32
	l7 = s1i32
	s2i32 = 3
	...
	*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+0)])) = uint64(s1i64)
	...
	lbl1:
		...
		s3f64 = l3
		s4i32 = l4
		s0f64 = f1423(ctx, s0i32, s1f64, s2f64, s3f64, s4i32)
		l9 = s0f64
		s1f64 = 0
		if s0f64 >= s1f64 {
			s0i32 = 1
