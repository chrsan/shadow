...
func f763(ctx *Context, l0 int32, l1 int32, l2 float32, l3 float32, l4 float32, l5 float32) {
	var l6 int32
	_ = l6
	var l7 float32
	_ = l7
	...
	l6 = s2i32
	s2f32 = *(*float32)(unsafe.Pointer(&ctx.Mem[int(s2i32+256)]))
	s3i32 = l6
	s3f32 = *(*float32)(unsafe.Pointer(&ctx.Mem[int(s3i32+320)]))
	s2f32 = s2f32 * s3f32
	l7 = s2f32
	s3f32 = l2
	s2f32 = s2f32 * s3f32
