...
func f1643(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	var l4 int32
	_ = l4
	var l5 int32
	_ = l5
	...
	*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+0)])) = uint32(s1i32)
	...
	s2f32 = l12
	s3i32 = l5
	f583(ctx, s0i32, s1i32, s2f32, s3i32)
	s0i32 = l5
	s0i32 = *(*int32)(unsafe.Pointer(&ctx.Mem[int(s0i32+0)]))
	l3 = s0i32
	if s0i32 == 0 {
...
lbl2:
	...
	*(*uint32)(unsafe.Pointer(&ctx.Mem[int(s0i32+100)])) = uint32(s1i32)
	...
	s0i32 = l4
	s1i32 = l6
	ctx.Mem[int(s0i32+116)] = uint8(s1i32)
	s0i32 = l4
	s1i32 = l0
	s2i32 = 8
	...
	*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+40)])) = uint64(s1i64)
	...
	s3i32 = 0
	s4i32 = l4
	s4i32 = *(*int32)(unsafe.Pointer(&ctx.Mem[int(s4i32+112)]))
	s5i32 = l4
...
lbl16:
	...
	*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+160)])) = uint64(s1i64)
	s0i32 = l4
	s1i32 = l1
	ctx.Mem[int(s0i32+178)] = uint8(s1i32)
	s0i32 = l4
	s1i32 = 0
	ctx.Mem[int(s0i32+183)] = uint8(s1i32)
	s0i32 = l4
	s1i32 = 0
	*(*uint16)(unsafe.Pointer(&ctx.Mem[int(s0i32+181)])) = uint16(s1i32)
	s0i32 = l4
	s1i32 = l4
	...
	ctx.Mem[int(s0i32+179)] = uint8(s1i32)
	s0i32 = l4
	s1i32 = l4
	s1i32 = int32(ctx.Mem[int(s1i32+116)])
	ctx.Mem[int(s0i32+180)] = uint8(s1i32)
	s0i32 = l4
	s1i64 = 0
