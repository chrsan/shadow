...
func f1466(ctx *Context, l0 int32, l1 int32, l2 int32) int32 {
	var l3 int32
	_ = l3
	var l4 int32
	_ = l4
	...
	*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+48)])) = uint64(s1i64)
	...
	s4i32 = l1
	s5i32 = l2
	s0i32 = f1476(ctx, s0i32, s1i32, s2i32, s3i32, s4i32, s5i32)
	l5 = s0i32
lbl0:
	s0i32 = l3
	s1i32 = 80
