...
func f718(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	var l5 int32
	_ = l5
	var l6 int32
	_ = l6
	...
	lbl2:
		...
		if s0i32 != 0 {
			...
			s0i32 = l1
			s1i32 = l2
			s1i32 = int32(ctx.Mem[int(s1i32+31)])
			l11 = s1i32
			s2i32 = -1
			s1i32 = s1i32 ^ s2i32
			...
			s1i64 = s1i64 * s2i64
			s2i32 = l1
			s2i64 = int64(ctx.Mem[int(s2i32+31)])
			l27 = s2i64
			s3i32 = l2
			...
			s2i32 = 8
			s1i32 = int32(uint32(s1i32) >> (uint32(s2i32) & 31))
			ctx.Mem[int(s0i32+22)] = uint8(s1i32)
			s0i32 = l1
			s1i64 = l25
			s2i64 = l55
			s1i64 = s1i64 * s2i64
			...
			s2i32 = 8
			s1i32 = int32(uint32(s1i32) >> (uint32(s2i32) & 31))
			ctx.Mem[int(s0i32+21)] = uint8(s1i32)
			s0i32 = l1
			s1i64 = l24
			s2i64 = l25
			s1i64 = s1i64 * s2i64
		...
		if s0i32 != 0 {
			...
			s1i64 = s1i64 * s2i64
			s2i32 = l1
			s2i64 = int64(ctx.Mem[int(s2i32+15)])
			l18 = s2i64
			s3i32 = l2
