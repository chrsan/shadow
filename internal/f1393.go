...
func f1393(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 float32, l6 int32) int32 {
	var l7 int32
	_ = l7
	var l8 int32
	_ = l8
	...
	*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+56)])) = uint64(s1i64)
	...
	s4i32 = 56
	s3i32 = s3i32 + s4i32
	s0i32 = f1392(ctx, s0i32, s1i32, s2i32, s3i32)
	if s0i32 == 0 {
		s0i32 = 1
	} else {
		s0i32 = 0
...
lbl6:
	...
	s3f32 = l10
	s4i32 = 1
	s1i32 = f557(ctx, s1i32, s2f32, s3f32, s4i32)
	l1 = s1i32
	ctx.Mem[int(s0i32+156)] = uint8(s1i32)
	s0i32 = l1
	if s0i32 == 0 {
