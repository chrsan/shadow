...
func f1567(ctx *Context, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32) {
	var l7 int32
	_ = l7
	var l8 int32
	_ = l8
...
lbl70:
	...
	*(*uint64)(unsafe.Pointer(&ctx.Mem[int(s0i32+48)])) = uint64(s1i64)
	...
	s4i32 = l17
	s5i32 = l18
	f1438(ctx, s0i32, s1i32, s2i32, s3i32, s4i32, s5i32)
	s0i32 = l4
	if s0i32 == 0 {
		s0i32 = 1
	} else {
...
lbl80:
	...
	s2i32 = l15
	s3i32 = l14
	s0i32 = f1711(ctx, s0i32, s1i32, s2i32, s3i32)
	if s0i32 != 0 {
		s0i32 = 12
		s0i32 = f17(ctx, s0i32)
		l0 = s0i32
